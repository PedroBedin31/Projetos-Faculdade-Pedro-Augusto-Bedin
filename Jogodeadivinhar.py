...
print("            Dificuldade: Fácil (1 a 100), Tentativas: 8                  ")
print("            Difculdade: Médio (1 a 500), Tentativas: 9                   ")
...
while palpite != numero_secreto:
    if palpite < numero_secreto:
        ...
        tentativas += 1
        if dificuldade == 1 and tentativas > 8:
            print("---------- FIM DE JOGO, VOCÊ PERDEU!!! ----------")
            print(f"Número secreto: {numero_secreto} ")
            print(f"Tentativas: {tentativas}")
            break
        elif dificuldade == 2 and tentativas > 9:
            print("---------- FIM DE JOGO, VOCÊ PERDEU!!! ----------")
            print(f"Número secreto: {numero_secreto} ")
            print(f"Tentativas: {tentativas}")
            break
